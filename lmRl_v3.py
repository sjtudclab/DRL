...
class lmmodel(Agent3):

    def __init__(self, config,sess):
        super(lmmodel,self).__init__('data/IF1602.CFE.csv', 20, 30, 10000)
        self.config = config
        self.sess =sess
        ...
        self.stepNum=30   #20 price sequence
    ...
    def discount_rewards(self,x, gamma):
        ...
        element = 0
        for i in range(len(x)-1, -1, -1):  # len(x)-2
    ...
    def learn(self):
        ...
        self.writer = tf.summary.FileWriter("/home/swy/code/DRL/tb3", self.sess.graph) 
        ...
        for i in range(10000):
            ...
            if i%100==0:
                print("num:%d",i)
                print(np.sum(trajectory["rews"]))
                print(trajectory["rews"])
                print(action)
...
def main():
    ...
    if tf.gfile.Exists('/home/swy/code/DRL/tb3'):
        tf.gfile.DeleteRecursively('/home/swy/code/DRL/tb3')
    tf.gfile.MakeDirs('/home/swy/code/DRL/tb3')
    ...
    save_path = out.saver.save(sess, '/home/swy/code/DRL/cp3/model.ckpt')


    #out = lmmodel(config=config,sess=sess)
    #load_path = out.saver.restore(sess,'/home/swy/code/DRL/cp3/model.ckpt')
    #out.learn()
