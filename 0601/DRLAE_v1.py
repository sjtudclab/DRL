...
class lmmodel(Agent2):
    ...
    def buildNetwork(self):
        self.states = tf.placeholder(tf.float32,shape=[None,240,self.inputSize],name= "states")
        ...
        with tf.variable_scope("Policy") :
            ...
            #loss,train
            self.entropy = -tf.reduce_sum(self.action0 * tf.log(self.action0), 1, name="entropy")
