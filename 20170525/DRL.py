    ...
    def learn(self):
        ...
        if trainfalse:
            ...
            for j in range(epoch):  
                ...
                super(lmmodel,self).__init__(stockList[0])
                ...
                for i in range(0,len(self.state)-batchsize-timestep,240+timestep):
                            ...
                            lr,actorResults = self.sess.run([self.lr ,self.actor_train],feed_dict={
                                self.states: state,
...
def main():
    ...
    if trainable:
        ...
        out.learn()
        save_path = out.saver.save(sess, '/home/swy/code/DRL/cpencoder/model0525.ckpt')
    else:
        out = lmmodel(config=config,sess=sess,FileList=L)
        load_path = out.saver.restore(sess,'/home/swy/code/DRL/cpencoder/model0525.ckpt')
        out.learn()
