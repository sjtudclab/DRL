...
class lmmodel(Agent2):
    ...
    def buildNetwork(self):
        ...
        self.states = tf.placeholder(tf.float32,shape=[None,None,self.inputSize],name= "states")
        ...
        with tf.variable_scope("Policy") :
            ...
            cell_drop=tf.contrib.rnn.DropoutWrapper(lstmcell, output_keep_prob=0.5) #防止过拟合
    ...
    def learn(self):
        ...
        for j in range(epoch):
            for k in range(12):
                ...
                total.append(np.sum(test_reward))
        print("total")
        print(total)
